<?php
  ...
  if(count($animales) > 0){
                ...
                <div class="card-horizontal scroll-card-horizontal">
                  <div id="card-body-horizontal" class="card-body">
                    <div class="row">
                      ...
                      if($animal['foto']){
                        echo '<img src="'.$animal['foto'].'" class="imagen-de-perfil" height="160" width="180">';
                        echo '<br>';
                      }else{
                        echo '<img src="http://via.placeholder.com/300x180" class="imagen-de-perfil" width="160" height="180">';
                      }
                      echo '</div>
                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
    ...
    echo '<br>';
    echo '<br>';
    echo '<h4 style="text-align:center;">El tablón de adopciones está vacío</h4>';
  }
?>
