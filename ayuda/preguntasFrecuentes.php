        ...
        <div class="container-fluid padding">
          <div class="row text-center padding">
            <div class="col-xs-12 col-sm-12 offset-md-2 col-md-4">
              <a href="preguntasFrecuentes.php"><img class="icono_usuario" src="../iconos/miscelanea/preguntasFrecuentes.png" height="100" width="100"></a>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4">
              <a href="comoFunciona.php"><img class="icono_usuario" src="../iconos/miscenelanea/comoFuncionaBlanco.PNG" height="100" width="100"></a>
