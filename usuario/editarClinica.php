                        ...
                        <div class="container-fluid padding">
                          <div class="row">
                            <div class="col-xs-12 mx-auto">
                              ...
                              <form name="formularioCambiarInfoObligatoria" id="formularioCambiarInfoObligatoria" action="cambiarObligatoriaClinica.php" method="post" onsubmit="return validarCorreoEditar($('#mail').val()) && validarTelefonoMovilEditar($('#movil').val())">
                                <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon">
